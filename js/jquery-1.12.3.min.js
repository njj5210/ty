...
!(function (a, b) {
  ...
  var c = [],
    ...
    var b;for (b in a) if (("data" !== b || !n.isEmptyObject(a[b])) && "toJSON" !== b) {
      return !1;
    }return !0;
  }function R(a, b, d, e) {
    if (M(a)) {
    ...
    if (M(a)) {
      var d,
        ...
        if (b && (d = c ? g[h] : g[h].data)) {
          n.isArray(b) ? b = b.concat(n.map(b, n.camelCase)) : b in d ? b = [b] : (b = n.camelCase(b), b = b in d ? [b] : b.split(" ")), e = b.length;while (e--) delete d[b[e]];if (c ? !Q(d) : !n.isEmptyObject(d)) {
            return;
          }
    ...
    }if ((null == d && null == e ? (e = c, d = c = void 0) : null == e && ("string" == typeof c ? (e = d, d = void 0) : (e = d, d = c, c = void 0)), e === !1)) e = qa;else if (!e) {
      return a;
    ...
    b = f.apply([], b);var e,
        ...
        p = o - 1,
        q = b[0],
        r = n.isFunction(q);if (r || o > 1 && "string" == typeof q && !l.checkClone && xa.test(q)) {
    ...
    if (a in ab) {
      return a;
        ...
        c = _a.length;while (c--) if ((a = _a[c] + b, a in ab)) {
      return a;
    }
  }function cb(a, b) {
    ...
    for (var d, e = (qb.tweeners[b] || []).concat(qb.tweeners["*"]), f = 0, g = e.length; g > f; f++) if (d = e[f].call(c, b, a)) {
      return d;
    }
  }function ob(a, b, c) {
    var d,
    ...
    var d,
      ...
      if (e) return !1;for (var b = hb || lb(), c = Math.max(0, j.startTime + j.duration - b), d = c / j.duration || 0, f = 1 - d, g = 0, i = j.tweens.length; i > g; g++) j.tweens[g].run(f);return (h.notifyWith(a, [j, f, c]), 1 > f && i ? c : (h.resolveWith(a, [j]), !1));
        ...
        k = j.props;for (pb(k, j.opts.specialEasing); g > f; f++) if (d = qb.prefilters[f].call(j, a, k, j.opts)) {
